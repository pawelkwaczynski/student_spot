...
Poniższe dane służą do zasilenia kodu seedującego. `guardian_name` i `contact_email` są wyłącznie metadanymi katalogowymi — nie tworzą kont.
...
# Zakres wdrożenia danych

Zakres wdrożenia danych obejmuje:
