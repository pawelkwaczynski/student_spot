...
- Seed demo ma miec 8 kont: `admin@studentspot.example.com`, `property@studentspot.example.com`, `guardian@studentspot.example.com`, `boss@studentspot.example.com`, `vice@studentspot.example.com`, `member@studentspot.example.com`, `pending@studentspot.example.com`, `utw@studentspot.example.com`, haslo `***REMOVED***`.
